...
-record(snake, {spi, snakehead, snakebody, snakelen, food, data1, data2, direction, gameover, goverproc, joystick_pid}).
-record(state, {spi, goverproc}).
